...
"""
# Actually I ran the code in kaggle but due to some issues i cant able to upload the .ipynb file in the git so I imported that code through Colab and converted to .py 
...
plt.tight_layout()
plt.show()
# At last the code teh display the results and analysis in the formate of some graph 
# I got some help from AI to built this code 
# pls contact or msg to this git or mail me if you found any issue or something you through to update in this methord that would really help to built this code up 
# You can either use cpu or gpu any thing to run this as it is less computational
# This code is done in teh competetion on kaggle https://www.kaggle.com/competitions/china-real-estate-demand-prediction  
# pls check the above link to get the dataset and know about the origin and ananlyse of this competetion
